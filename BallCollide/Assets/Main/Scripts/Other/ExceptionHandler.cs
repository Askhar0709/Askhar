...
public class ExceptionHandler : MonoBehaviour
{
    ...
    void Update()
    {
        dt = A.Clamp(dt + Time.deltaTime, 0, time);
        t = curve.Evaluate(dt / time);
        style.fontSize = fontSize;
        style.normal.textColor = A.ColA(foregroundColor, foregroundColor.a * t);
        style.normal.background = FillTexture(1, 1, A.ColA(backgroundColor, backgroundColor.a * t));
    }
    void OnGUI()
    {
