    ...
    public class UIParticleRenderer : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (textureSheetAnimation.enabled)
                {
                    ...
                    frameProgress = A.Rep(frameProgress * textureSheetAnimation.cycleCount, 1);
                    int frame = 0;
        ...
        void Update()
        {
            if (!fixedTime && Application.isPlaying)
            {
                ...
                if ((currentMaterial.NotNull() && currentTexture != currentMaterial.mainTexture) ||
                    (material.NotNull() && currentMaterial.NotNull() && material.shader != currentMaterial.shader))
                {
                    pSystem = null;
                    Initialize();
                }
